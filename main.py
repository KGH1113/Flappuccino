...
def main():
    ...
    # get fonts
    font = pygame.font.Font('/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/fonts/font.otf', 100)
    font_small = pygame.font.Font('/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/fonts/font.otf', 32)
    font_20 = pygame.font.Font('/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/fonts/font.otf', 20)
    # get some images
    shop = pygame.image.load('/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/gfx/shop.png')
    shop_bg = pygame.image.load('/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/gfx/shop_bg.png')
    retry_button = pygame.image.load('/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/gfx/retry_button.png')
    logo = pygame.image.load('/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/gfx/logo.png')
    title_bg = pygame.image.load('/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/gfx/bg.png')
    title_bg.fill((255, 30.599999999999998, 0.0), special_flags=pygame.BLEND_ADD)
    shadow = pygame.image.load('/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/gfx/shadow.png')
    # get sounds
    flapfx = pygame.mixer.Sound("/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/sfx/flap.wav")
    upgradefx = pygame.mixer.Sound("/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/sfx/upgrade.wav")
    beanfx = pygame.mixer.Sound("/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/sfx/bean.wav")
    deadfx = pygame.mixer.Sound("/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/sfx/dead.wav")
    # colors
    ...
    buttons[0].typeIndicatorSprite = pygame.image.load('/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/gfx/flap_indicator.png')
    buttons[0].price = 5   
    buttons[1].typeIndicatorSprite = pygame.image.load('/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/gfx/speed_indicator.png')
    buttons[1].price = 5 
    buttons[2].typeIndicatorSprite = pygame.image.load('/Users/gang-guhyeon1/Desktop/Python/Flappuccino-main/data/gfx/beanup_indicator.png')
    buttons[2].price = 30
    # getting 5 beans
